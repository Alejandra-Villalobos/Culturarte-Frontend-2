...
function EditSpecificEvent() {
  ...
  return (
    <div class="flex font-montserrat">
      ...
      <div className="my-5 max-sm:mx-5 w-4/5">
        ...
        <div class="w-full max-sm:flex-col max-sm:gap-3 flex my-10 justify-center max-sm:items-center">
          <div class="max-sm:w-4/5">
            <div class="max-sm:w-4/5 w-full felx flex-col">
              <h2>Imagen promocional</h2>
              <PromotionalImage />
            </div>
            <div class="flex max-sm:gap-3 justify-between gap-3 my-3 w-full">
              <div>
                <h2>Titulo</h2>
                <Input
                  class="w-full"
